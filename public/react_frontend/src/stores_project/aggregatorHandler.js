...
export default class AggregatorHandler extends StoreComponent{

    @observable editing;//bool
    @observable entry;//document new version
    @observable entryId;//id oglf edited element
    @observable updateInProgress;
   
    //add entry to store and its id to array
    @action addEntry( aggregator ){
