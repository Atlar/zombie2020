...
export default class SidAgent extends StoreComponent{
    ...
    sendCommand = (functionName, args)=>{
        ...
        console.log("doesfunction exist  " +functionName + " " +this.commands[functionName] + this.commands  + " test fun " + this.commands.getRootAPIUrl() + " test fun object " + this.commands.getRootAPIUrl + " test target "+ this.CreateAndAddToAggregation);
        this.ResponseReceived=false;
